...
<body>
    ...
    <div class="container-fluid py-1 px-5">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item p-lg-1">
            <a style="font-size: 20px;" class="nav-link" id="accnBox" href="shop.php?pageno=1">Go to Market</a>
          </li>
          <li class="nav-item p-lg-1">
  ...
  <section id="market" class="mt-1 py-5">
    <div class="container text-center mt-5">
      ...
      <hr>
      <p>
        Simply choose on which you are interested.
      </p>
    </div>
    ...
    <div class="container text-center pt-5">
      ...
      if ($y < 0) {
        ...
        echo "<a href='shop.php?pageno=$y'><button id='new1'>Back to previous</button></a>";
      }
      // echo $x.' '.$max_page.' '.$num_rows;
      if ($x >= $max_page) {
         echo '<button disabled id="new2" style="background-color: grey; transform: scale(0.0); transition: 0s;">Go to next</button>';
      } else {
        echo "<a href='shop.php?pageno=$x'><button id='new2'>Go to next</button></a>";
      }
      ?>
    </div>
