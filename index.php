...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item p-lg-1">
                        <a style="font-size: 20px;" class="nav-link" id="accnBox" href="#home">Home</a>
                    </li>
                    <li class="nav-item p-lg-1">
                        <a style="font-size: 20px;" class="nav-link" id="accnBox" href="#market">Go to Market</a>
                    </li>
                    <li class="nav-item p-lg-1">
                        <a style="font-size: 20px; color: #F39C12;" class="nav-link" id="accnBox" href="login.php">POST
                            your AD</a>
                    </li>
                    <li class="nav-item p-lg-1">
                        <a style="font-size: 20px;" class="nav-link" id="accnBox" href="#about">About</a>
                    </li>
                    <li class="nav-item p-lg-1">
                        <a style="font-size: 20px;" class="nav-link" id="accnBox" href="#footer">Contact Us</a>
                    </li>
                    <li class="nav-item p-lg-1">
    ...
    <section id="home">
        <div class="container">
            ...
            <br>
            <a href="login.php" id="exp" style="text-decoration: none; color: white;"><button style="font-size: 25px;">Explore Now</a></button></a>
        </div>
    </section>
    ...
    <section id="market">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (!isset($id[0])) {
                            ...
                            echo "<a href='login.php' style='text-decoration: none; color: white;'>
        ...
        <div class="container text-center pt-5">
            <a href="login.php" style="text-decoration: none; color: white;"><button style="font-size: 20px;">Explore
                    More</button></a>
        </div>
    </section>
