...
<head>
    ...
    <title>Sign Up | motoXchange</title>
    ...
    <script>
        function error1() {
            window.alert("OPPS!! This email is already used, Try Another");
        }

        function error2() {
            window.alert("OPPS!! This username exists. Try another");
        }

        function error3() {
            window.alert("OPPS!! Password does not matched!");
        }
    </script>
</head>
...
<body>
    ...
    <section class="login py-5 mt-5">
        <div class="container text-center mt-4">
            <h3 style="color: crimson;">Sign UP here</h3>
            <hr>
            <p> Don't have a <strong style="font-size: 20px;"><span style="color: red;">moto</span>X<span style="color: rgb(104, 101, 101);">change</span></strong> account ?
                Just do it with a few seconds. </p>
        </div>
        <div class="container mt-5">
            <div class="row g-0 row1">
                <div class="col-lg-6">
                    <img style="border-radius: 30px; box-shadow: 5px 5px 30px" src="Images/car14.jpg" alt="" class="img-fluid">
                </div>
                    ...
                    <form action="" method="POST">
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="text" name="name" id="inp" class="px-3" placeholder="Enter your full name">
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="email" name="email" id="inp" class="px-3" placeholder="Enter your email">
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="tel" size="11" id="inp" pattern="01[0-9]{9}" name="phone" class="px-3" placeholder="Enter your Active phone no.">
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="url" name="facebook" id="inp" class="px-3" placeholder="Add your facebook ID url">
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="tel" size="11" id="inp" pattern="01[0-9]{9}" name="whatsapp" class="px-3" placeholder="Enter your whatsapp number">
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <textarea class="txt px-3" name="address" cols="30" rows="5" style="width: 80%; border: 2px solid black; outline: none;
                                border-radius: 10px; box-shadow: 10px 10px 20px rgb(48, 47, 47);" placeholder="Enter your detail address"></textarea>
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="text" name="username" id="inp" class="px-3" placeholder="Choose your UserName">
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="password" name="password" id="inp" class="px-3" placeholder="Enter your Password">
                            </div>
                        </div>
                        <div class="form-row py-3 pt-4">
                            <div class="offset-1 col-lg-10">
                                <input type="password" name="cpassword" id="inp" class="px-3" placeholder="Confirm your Password">
                            </div>
                        </div>
                        <div class="form-row py-4">
                            <div class="offset-1 col-lg-10">
                                <button class="btn1" name="submit">Sign UP</button><br><br>
                                Already have an account? <a href="login.php" id="signup">Sign IN</a>
                            </div>
                        </div>
                    </form>
                </div>
